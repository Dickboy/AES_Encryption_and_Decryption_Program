...
class GraphInterface(Frame):
    ...
    def createWidgets(self):
        ...
        self.alertButton1.pack(side = BOTTOM, padx=2, pady=10)
        ...
        self.alertButton2.pack(side = BOTTOM, padx=2, pady=10)
    ...
    def encrypt(self):
        ...
        if self.filename1 == "":
            ...
            if mode == 'ECB模式':
                encrypt_AES_file(self.filename1, self.filename2, "C:\\Users\\Sherlock Holmes\\Desktop\\ciphertext.txt", 'ECB')
                ...
                encrypt_AES_file(self.filename1, self.filename2, "C:\\Users\\Sherlock Holmes\\Desktop\\ciphertext.txt", 'CBC')
                ...
                encrypt_AES_file(self.filename1, self.filename2, "C:\\Users\\Sherlock Holmes\\Desktop\\ciphertext.txt", 'CFB')
                ...
                encrypt_AES_file(self.filename1, self.filename2, "C:\\Users\\Sherlock Holmes\\Desktop\\ciphertext.txt", 'OFB')
    ...
    def decrypt(self):
        ...
        if self.filename3 == "":
            ...
            if mode == 'ECB模式':
                decrypt_AES_file(self.filename3, self.filename4, "C:\\Users\\Sherlock Holmes\\Desktop\\result.txt", 'ECB')
                messagebox.showinfo('Message', 'Success encrypt plaintext file: ' + self.filename1 + ' using password file ' + self.filename2 + ' under ECB Mode!')
            elif mode == 'CBC模式':
                decrypt_AES_file(self.filename3, self.filename4, "C:\\Users\\Sherlock Holmes\\Desktop\\result.txt", 'CBC')
                messagebox.showinfo('Message', 'Success encrypt plaintext file: ' + self.filename1 + ' using password file ' + self.filename2 + ' under CBC Mode!')
            elif mode == 'CFB模式':
                decrypt_AES_file(self.filename3, self.filename4, "C:\\Users\\Sherlock Holmes\\Desktop\\result.txt", 'CFB')
                messagebox.showinfo('Message', 'Success encrypt plaintext file: ' + self.filename1 + ' using password file ' + self.filename2 + ' under CFB Mode!')
            elif mode == 'OFB模式':
                decrypt_AES_file(self.filename3, self.filename4, "C:\\Users\\Sherlock Holmes\\Desktop\\result.txt", 'OFB')
                messagebox.showinfo('Message', 'Success encrypt plaintext file: ' + self.filename1 + ' using password file ' + self.filename2 + ' under OFB Mode!')
            else:
                messagebox.showinfo('Message', '您还未选择加密模式！')
